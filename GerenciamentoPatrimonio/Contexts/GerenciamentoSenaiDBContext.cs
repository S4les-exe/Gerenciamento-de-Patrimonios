...
public partial class GerenciamentoSenaiDBContext : DbContext
{
    public GerenciamentoSenaiDBContext()
    {
    }

    public GerenciamentoSenaiDBContext(DbContextOptions<GerenciamentoSenaiDBContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=GerenciamentoSenaiDB;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Area>(entity =>
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B820288644E17A");
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A093623DE80AC9F");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665ED0BAD8270");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DEBE5E0C15").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B6800959B5C37147");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462F24B23921");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECA381D5185");
        ...
        {
            entity.HasKey(e => e.LogPatrimonio1).HasName("PK__LogPatri__7E42576433906EF4");

            entity.Property(e => e.LogPatrimonio1)
                .HasDefaultValueSql("(newid())")
                .HasColumnName("LogPatrimonio");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDE71D50CCD");
            ...
            entity.HasOne(d => d.Localizacao).WithMany(p => p.Patrimonio)
                .HasForeignKey(d => d.LocalizacaoID)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Patrimonio_ocalizacao");
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F20AE01D94");
            ...
            entity.HasOne(d => d.Localizacao).WithMany(p => p.SolicitacaoTransferencia)
                .HasForeignKey(d => d.LocalizacaoID)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StatusTransferencia_Localizacao");

            entity.HasOne(d => d.Patrimonio).WithMany(p => p.SolicitacaoTransferencia)
                .HasForeignKey(d => d.PatrimonioID)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StatusTransferencia_Patrimonio");
            ...
            entity.HasOne(d => d.UsuarioIDAprovacaoNavigation).WithMany(p => p.SolicitacaoTransferenciaUsuarioIDAprovacaoNavigation)
                ...
                .HasConstraintName("FK_StatusTransferencia_UsuarioAprovacao");
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F336090764A8AC");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1A63665B5B").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B90BB039CF");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1AB4602315").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0D09F903F5");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoAlte__7859A10AB6C71842").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C702E75F18B8");
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE79852C1B6FF");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA296A5FCEA").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D105349F153D58").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F89731384A9EBE").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC3309399AAA2").IsUnique();
